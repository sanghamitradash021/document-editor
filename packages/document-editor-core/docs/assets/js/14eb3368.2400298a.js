...
(self.webpackChunkdocusaurus = self.webpackChunkdocusaurus || []).push([
  [817],
  {
    1310: (e, t, a) => {
      ...
      const h = { breadcrumbHomeIcon: 'breadcrumbHomeIcon_YNFT' };
      function b() {
        const e = (0, d.Z)('/');
        return r.createElement(
          'li',
      ...
      const v = { breadcrumbsContainer: 'breadcrumbsContainer_Z_bl' };
      function g(e) {
              ...
              r.createElement(
                ...
                e.map((t, a) => {
                  ...
                  return r.createElement(
                    ...
                    r.createElement(g, { href: t.href, isLast: n }, t.label)
                  );
                })
              )
            )
    ...
    2503: (e, t, a) => {
      ...
      function m(e) {
        ...
        if ('h1' === t || !a)
          return r.createElement(t, (0, n.Z)({}, m, { id: void 0 }));
        const u = (0, l.I)(
          {
          ...
          { heading: 'string' == typeof m.children ? m.children : a }
        );
        return r.createElement(
          t,
          (0, n.Z)({}, m, {
            className: (0, i.Z)(
              'anchor',
              d ? o.anchorWithHideOnScrollNavbar : o.anchorWithStickyNavbar,
              m.className
            ),
            id: a,
          }),
          ...
          r.createElement(
            c.Z,
            { className: 'hash-link', to: `#${a}`, 'aria-label': u, title: u },
            '\u200b'
          )
        );
      }
