    ...
    9074: (e, t, r) => {
      ...
      const o = { sidebar_position: 1 },
        ...
        i = {
          ...
          permalink: '/canvas-editor/docs/release/change-logs',
          draft: !1,
          tags: [],
          version: 'current',
          sidebarPosition: 1,
          ...
          next: {
            title: 'Release notes',
            permalink: '/canvas-editor/docs/release/release-notes',
          },
        },
        s = {},
        u = [{ value: 'Version 1', id: 'version-1', level: 2 }],
        c = { toc: u },
        p = 'wrapper';
      function d(e) {
        ...
        return (0, a.kt)(
          ...
          (0, a.kt)('h1', { id: 'change-logs' }, 'Change logs'),
          (0, a.kt)('h2', { id: 'version-1' }, 'Version 1'),
          (0, a.kt)(
            'ul',
            null,
            (0, a.kt)(
              ...
              { parentName: 'ul' },
              'Added ',
              (0, a.kt)('strong', { parentName: 'li' }, 'Bold'),
            ...
            (0, a.kt)(
              ...
              { parentName: 'ul' },
              'Added ',
              (0, a.kt)('strong', { parentName: 'li' }, 'Redo'),
            ...
            (0, a.kt)(
              ...
              { parentName: 'ul' },
              'Added ',
              (0, a.kt)('strong', { parentName: 'li' }, 'Italic'),
              ' feature for text formatting.'
            ),
            (0, a.kt)(
              'li',
              { parentName: 'ul' },
              'Added ',
              (0, a.kt)('strong', { parentName: 'li' }, 'Underline'),
              ' feature for text formatting.'
            ),
            (0, a.kt)(
              'li',
            ...
            (0, a.kt)(
              ...
              { parentName: 'ul' },
              'Added ',
              (0, a.kt)('strong', { parentName: 'li' }, 'Undo'),
            ...
            (0, a.kt)(
              ...
              { parentName: 'ul' },
              'Added ',
              (0, a.kt)('strong', { parentName: 'li' }, 'Image'),
            ...
            (0, a.kt)(
              ...
              (0, a.kt)(
                ...
                (0, a.kt)(
                  'li',
                  { parentName: 'ul' },
                  (0, a.kt)('strong', { parentName: 'li' }, 'onChange'),
                  ': Allows you to listen to changes in the DOM.'
                ),
                (0, a.kt)(
                  'li',
                  { parentName: 'ul' },
                  (0, a.kt)('strong', { parentName: 'li' }, 'onSelect'),
          ...
          (0, a.kt)('p', null, 'Thank you for using our software!')
        );
      }
      d.isMDXComponent = !0;
    },
