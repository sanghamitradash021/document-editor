      ...
      var s = r.createContext({}),
        ...
        f = r.forwardRef(function (e, t) {
          var n = e.components,
            ...
            p = u(n),
            f = o,
            h = p[''.concat(s, '.').concat(f)] || p[f] || d[f] || i;
          return n
            ? r.createElement(h, a(a({ ref: t }, c), {}, { components: n }))
            : r.createElement(h, a({ ref: t }, c));
        });
      function h(e, t) {
        var n = arguments,
          o = t && t.mdxType;
    ...
    4271: (e, t, n) => {
      ...
      const i = { sidebar_position: 1 },
        ...
        l = {
          ...
          permalink: '/canvas-editor/docs/contributors/how-to-contribute',
          draft: !1,
          tags: [],
          version: 'current',
          sidebarPosition: 1,
          ...
          previous: {
            title: 'Contributors',
            permalink: '/canvas-editor/docs/contributors/',
          },
          next: {
            title: 'Code of conduct',
            permalink: '/canvas-editor/docs/contributors/code-of-conduce',
          },
        },
        s = {},
        u = [
      ...
      function d(e) {
        ...
        return (0, o.kt)(
          ...
          (0, o.kt)('h1', { id: 'how-to-contribute' }, 'How to contribute'),
          (0, o.kt)(
            'p',
            null,
            'We deeply appreciate your interest in contributing to the Canvas Editor project. Your valuable contributions play a pivotal role in enhancing this project. Before you begin, please take a moment to review the following guidelines.'
          ),
          (0, o.kt)('h2', { id: 'table-of-contents' }, 'Table of Contents'),
          (0, o.kt)(
            'ul',
            null,
            (0, o.kt)(
          ...
          (0, o.kt)(
            ...
            (0, o.kt)(
              'li',
              { parentName: 'ol' },
              'Initiate the process by downloading the installer for the Long-Term Support (LTS) version of Node.js. This step also facilitates npm installation.'
            ),
            (0, o.kt)(
              'li',
              { parentName: 'ol' },
            ...
            (0, o.kt)(
              'li',
              { parentName: 'ol' },
              'Execute npm install to install the required dependencies for this package.'
            ),
            (0, o.kt)(
              'li',
              { parentName: 'ol' },
              "Gain insights into the document editor's functionality by running npm run storybook."
            )
          ),
          (0, o.kt)(
            'h2',
          ...
          (0, o.kt)('h2', { id: 'making-changes' }, 'Making Changes'),
          (0, o.kt)(
            'ol',
            null,
            (0, o.kt)(
              'li',
              { parentName: 'ol' },
              'Establish a new branch within your forked repository, providing it with a descriptive name.'
            ),
            (0, o.kt)(
              'li',
              { parentName: 'ol' },
              'Implement the desired feature or rectify the identified issue within your branch.'
            ),
            (0, o.kt)(
              'li',
              { parentName: 'ol' },
          ...
          (0, o.kt)(
            ...
            (0, o.kt)(
              'li',
              { parentName: 'ol' },
              'Furnish a clear and concise description of the changes within the PR.'
            ),
            (0, o.kt)(
              'li',
              { parentName: 'ol' },
          ...
          (0, o.kt)('h2', { id: 'code-of-conduct' }, 'Code of Conduct'),
          (0, o.kt)(
            'p',
            null,
          ...
          (0, o.kt)('h2', { id: 'licensing' }, 'Licensing'),
          (0, o.kt)(
            'p',
            null,
