  ...
  [455],
  {
      ...
      var i = o.createContext({}),
        ...
        p = o.forwardRef(function (e, t) {
          var n = e.components,
            ...
            m = s(n),
            p = r,
            f = m[''.concat(i, '.').concat(p)] || m[p] || d[p] || a;
          return n
    ...
    2503: (e, t, n) => {
      ...
      function u(e) {
        ...
        if ('h1' === t || !n)
          return r.createElement(t, (0, o.Z)({}, u, { id: void 0 }));
        const d = (0, c.I)(
          {
        ...
        return r.createElement(
          ...
          (0, o.Z)({}, u, {
            className: (0, a.Z)(
              'anchor',
              m ? s.anchorWithHideOnScrollNavbar : s.anchorWithStickyNavbar,
              u.className
            ),
            id: n,
          }),
          ...
          r.createElement(
            i.Z,
            { className: 'hash-link', to: `#${n}`, 'aria-label': d, title: d },
            '\u200b'
          )
        );
      }
    ...
    1506: (e, t, n) => {
      ...
      function v(e, t) {
        const n = e
          .map(e => {
            const { start: n, end: o } = y[e];
            return `(?:${n}\\s*(${t.flatMap(e => [e.line, e.block?.start, e.block?.end].filter(Boolean)).join('|')})\\s*${o})`;
          })
          .join('|');
      ...
      function b(e, t) {
        ...
        if (a && g.test(a)) {
          const e = a.match(g).groups.range;
          if (0 === r.length)
            throw new Error(
        ...
        const c = (function (e, t) {
          ...
          i = Object.fromEntries(
            r.map(e => [e.className, { start: 0, range: '' }])
          ),
        ...
        return (
          ...
          { lineClassNames: d, code: n }
        );
      }
      const E = { codeBlockContainer: 'codeBlockContainer_Ckt0' };
      function k(e) {
        let { as: t, ...n } = e;
        const r = (function (e) {
          const t = {
      ...
      function C(e) {
        ...
        return o.createElement(
          ...
          o.createElement('code', { className: N.codeBlockLines }, t)
        );
      }
      var L = n(902);
      const w = {
      ...
      function B(e, t) {
        const [n, r] = (0, o.useState)(),
          a = (0, o.useCallback)(() => {
            r(e.current?.closest('[role=tabpanel][hidden]'));
          }, [e, r]);
        (0, o.useEffect)(() => {
          a();
        }, [a]),
          ...
          e.apply(this, n),
            ...
            O(this, 'getLineProps', function (e) {
              var n = e.key,
                o = e.className,
                r = e.style,
                a = Z({}, S(e, ['key', 'className', 'style', 'line']), {
              ...
              return (
                ...
                void 0 !== r &&
                  (a.style = void 0 !== a.style ? Z({}, a.style, r) : r),
                void 0 !== n && (a.key = n),
                o && (a.className += ' ' + o),
                a
              );
            ...
            O(this, 'getStyleForToken', function (e) {
              ...
              if (void 0 !== a) {
                if (1 === r && 'plain' === n[0])
                  return o ? { display: 'inline-block' } : void 0;
            ...
            O(this, 'getTokenProps', function (e) {
              var n = e.key,
                ...
                r = e.style,
                a = e.token,
                c = Z({}, S(e, ['key', 'className', 'style', 'token']), {
              ...
              return (
                void 0 !== r &&
                  (c.style = void 0 !== c.style ? Z({}, c.style, r) : r),
                void 0 !== n && (c.key = n),
                o && (c.className += ' ' + o),
                c
              );
            }),
            O(this, 'tokenize', function (e, t, n, o) {
                  ...
                  for (; (a = o[c]++) < r[c]; ) {
                    ...
                    if (
                      ...
                      for (var f = 1; f < p; f++)
                        H(l),
                          i.push((l = [])),
                          l.push({ types: u, content: d[f] });
                    } else
                      c++, t.push(u), n.push(s), o.push(0), r.push(s.length);
                  }
      ...
      function z(e) {
        ...
        const s = c({ line: t, className: (0, i.Z)(n, r && P.codeLine) }),
          u = t.map((e, t) =>
            o.createElement(
              'span',
        ...
        return o.createElement(
          ...
          r
            ? o.createElement(
                o.Fragment,
                null,
                o.createElement('span', { className: P.codeLineNumber }),
                o.createElement('span', { className: P.codeLineContent }, u)
              )
            : u,
      ...
      function V(e) {
        ...
        return (
          (0, o.useEffect)(() => () => window.clearTimeout(c.current), []),
          o.createElement(
            'button',
            {
              type: 'button',
            ...
            o.createElement(
              ...
              o.createElement(D, { className: R.copyButtonIcon }),
              o.createElement(W, { className: R.copyButtonSuccessIcon })
            )
          )
        );
      }
      ...
      function F(e) {
        let { className: t, onClick: n, isEnabled: r } = e;
        const a = (0, M.I)({
        ...
        return o.createElement(
          'button',
          {
            type: 'button',
            onClick: n,
            className: (0, i.Z)('clean-btn', t, r && q.wordWrapButtonEnabled),
            'aria-label': a,
            title: a,
          },
          o.createElement($, {
            className: q.wordWrapButtonIcon,
            'aria-hidden': 'true',
          })
        );
      }
      function U(e) {
        ...
        const {
            prism: { defaultLanguage: d, magicComments: p },
          } = (0, u.L)(),
          f =
            s ??
            (function (e) {
        ...
        return o.createElement(
          k,
          {
            ...
            className: (0, i.Z)(
              n,
              f && !n.includes(`language-${f}`) && `language-${f}`
            ),
          },
          v && o.createElement('div', { className: N.codeBlockTitle }, v),
          o.createElement(
            'div',
            { className: N.codeBlockContent },
            o.createElement(
              I,
              (0, a.Z)({}, T, { theme: g, code: C, language: f ?? 'text' }),
              e => {
                let {
                  className: t,
                  tokens: n,
                ...
                return o.createElement(
                  ...
                  o.createElement(
                    'code',
                    {
                      className: (0, i.Z)(
                        N.codeBlockLines,
                        L && N.codeBlockLinesWithNumbering
                      ),
                    },
                    n.map((e, t) =>
                      o.createElement(z, {
            ...
            o.createElement(
              ...
              (y.isEnabled || y.isCodeScrollable) &&
                o.createElement(F, {
                  className: N.codeButton,
                  onClick: () => y.toggle(),
                  isEnabled: y.isEnabled,
                }),
              o.createElement(V, { className: N.codeButton, code: C })
            )
          )
        );
      }
      function G(e) {
        ...
        const r = (0, l.Z)(),
          c = (function (e) {
            return o.Children.toArray(e).some(e => (0, o.isValidElement)(e))
              ? e
              : Array.isArray(e)
                ? e.join('')
                : e;
          })(t),
          i = 'string' == typeof c ? U : C;
        return o.createElement(i, (0, a.Z)({ key: String(r) }, n), c);
      }
      var Y = n(9960);
      var Q = n(6043);
      const X = {
      ...
      function J(e) {
        return !!e && ('SUMMARY' === e.tagName || J(e.parentElement));
      }
      function K(e, t) {
        return !!e && (e === t || K(e.parentElement, t));
      }
      function ee(e) {
        let { summary: t, children: n, ...r } = e;
        const c = (0, l.Z)(),
          s = (0, o.useRef)(null),
          { collapsed: u, setCollapsed: m } = (0, Q.u)({
            initialState: !r.open,
          }),
          [d, p] = (0, o.useState)(r.open),
          f = o.isValidElement(t)
            ? t
            : o.createElement('summary', null, t ?? 'Details');
        return o.createElement(
          'details',
          (0, a.Z)({}, r, {
            ref: s,
            open: d,
            'data-collapsed': u,
            className: (0, i.Z)(X.details, c && X.isBrowser, r.className),
            onMouseDown: e => {
              J(e.target) && e.detail > 1 && e.preventDefault();
            },
            onClick: e => {
              e.stopPropagation();
              const t = e.target;
              J(t) &&
                K(t, s.current) &&
                (e.preventDefault(), u ? (m(!1), p(!0)) : m(!0));
            },
          }),
          f,
          o.createElement(
            ...
            o.createElement('div', { className: X.collapsibleContent }, n)
          )
        );
      }
      const te = { details: 'details_b_Ee' },
        ne = 'alert alert--info';
      function oe(e) {
        let { ...t } = e;
        return o.createElement(
          ee,
          (0, a.Z)({}, t, { className: (0, i.Z)(ne, te.details, t.className) })
        );
      }
      var re = n(2503);
      function ae(e) {
        return o.createElement(re.Z, e);
      }
      const ce = { containsTaskList: 'containsTaskList_mC6p' };
      function le(e) {
        if (void 0 !== e)
          return (0, i.Z)(
            e,
            e?.includes('contains-task-list') && ce.containsTaskList
          );
      }
      const ie = { img: 'img_ev3q' };
      const se = 'admonition_LlT9',
        ue = 'admonitionHeading_tbUL',
        me = 'admonitionIcon_kALy',
        de = 'admonitionContent_S0QG';
      const pe = {
          note: {
      ...
      const ge = {
        head: function (e) {
          const t = o.Children.map(e.children, e =>
            o.isValidElement(e)
              ? (function (e) {
                  if (e.props?.mdxType && e.props.originalType) {
                    const { mdxType: t, originalType: n, ...r } = e.props;
                    return o.createElement(e.props.originalType, r);
                  }
                  return e;
                })(e)
              : e
          );
          return o.createElement(c.Z, e, t);
        },
        code: function (e) {
          const t = [
            'a',
          ...
          return o.Children.toArray(e.children).every(
            e =>
              ('string' == typeof e && !e.includes('\n')) ||
              ((0, o.isValidElement)(e) && t.includes(e.props?.mdxType))
          )
            ? o.createElement('code', e)
            : o.createElement(G, e);
        },
        a: function (e) {
          return o.createElement(Y.Z, e);
        },
        pre: function (e) {
          return o.createElement(
            G,
            (0, o.isValidElement)(e.children) &&
        ...
        details: function (e) {
          const t = o.Children.toArray(e.children),
            n = t.find(
              e => o.isValidElement(e) && 'summary' === e.props?.mdxType
            ),
            r = o.createElement(
              o.Fragment,
              null,
          ...
          return o.createElement(oe, (0, a.Z)({}, e, { summary: n }), r);
        },
        ul: function (e) {
          return o.createElement(
            'ul',
            (0, a.Z)({}, e, { className: le(e.className) })
          );
        },
        img: function (e) {
          return o.createElement(
            ...
            (0, a.Z)({ loading: 'lazy' }, e, {
              className: ((t = e.className), (0, i.Z)(t, ie.img)),
            })
          );
          var t;
        },
        h1: e => o.createElement(ae, (0, a.Z)({ as: 'h1' }, e)),
        h2: e => o.createElement(ae, (0, a.Z)({ as: 'h2' }, e)),
        h3: e => o.createElement(ae, (0, a.Z)({ as: 'h3' }, e)),
        h4: e => o.createElement(ae, (0, a.Z)({ as: 'h4' }, e)),
        h5: e => o.createElement(ae, (0, a.Z)({ as: 'h5' }, e)),
        h6: e => o.createElement(ae, (0, a.Z)({ as: 'h6' }, e)),
        admonition: function (e) {
          const { children: t, type: n, title: r, icon: a } = he(e),
            c = (function (e) {
              const t = fe[e] ?? e,
                n = pe[t];
              return (
                n ||
                (console.warn(
                  `No admonition config found for admonition type "${t}". Using Info as fallback.`
                ),
                pe.info)
              );
            })(n),
      ...
      function ye(e) {
        let { children: t } = e;
        return o.createElement(r.Zo, { components: ge }, t);
      }
    },
    9407: (e, t, n) => {
      'use strict';
      ...
      function u(e) {
        ...
        return r.createElement(
          'div',
          { className: (0, a.Z)(l.tableOfContents, 'thin-scrollbar', t) },
          r.createElement(
            c.Z,
            (0, o.Z)({}, n, { linkClassName: i, linkActiveClassName: s })
          )
        );
      }
    },
    3743: (e, t, n) => {
      ...
      function c(e) {
        ...
        return (
          t.forEach(e => {
            ...
            n >= 0 ? t[n].children.push(r) : o.push(r);
          }),
          o
        );
      }
      ...
      function d(e) {
        let { toc: t, className: n, linkClassName: o, isChild: a } = e;
        return t.length
          ? r.createElement(
              'ul',
      ...
      function f(e) {
        ...
        const h = (0, a.L)(),
          g = u ?? h.tableOfContents.minHeadingLevel,
          y = d ?? h.tableOfContents.maxHeadingLevel,
          v = (function (e) {
            let { toc: t, minHeadingLevel: n, maxHeadingLevel: o } = e;
            return (0, r.useMemo)(
              () => l({ toc: c(t), minHeadingLevel: n, maxHeadingLevel: o }),
              [t, n, o]
            );
          })({ toc: t, minHeadingLevel: g, maxHeadingLevel: y });
        return (
          m(
            (0, r.useMemo)(() => {
              if (i && s)
          ...
          r.createElement(
            p,
            (0, o.Z)({ toc: v, className: n, linkClassName: i }, f)
          )
        );
      }
    },
