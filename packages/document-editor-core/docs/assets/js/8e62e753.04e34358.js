      ...
      var c = r.createContext({}),
        ...
        m = r.forwardRef(function (e, t) {
          var n = e.components,
            ...
            u = l(n),
            m = a,
            f = u[''.concat(c, '.').concat(m)] || u[m] || p[m] || o;
          return n
            ? r.createElement(f, i(i({ ref: t }, d), {}, { components: n }))
    ...
    5241: (e, t, n) => {
      ...
      const o = { sidebar_position: 2 },
        ...
        s = {
          ...
          title: 'Quick Start',
          description: "Let's discover Canvas Editor in less than 5 minutes.",
          source: '@site/docs/Get-started/quickstart.md',
          sourceDirName: 'Get-started',
          slug: '/Get-started/quickstart',
          permalink: '/canvas-editor/docs/Get-started/quickstart',
          draft: !1,
          tags: [],
          version: 'current',
          sidebarPosition: 2,
          ...
          previous: {
            title: 'Installation',
            permalink: '/canvas-editor/docs/Get-started/Installation',
          },
          next: {
            title: 'References',
        ...
        l = [
          ...
          { value: 'toolbar.jsx', id: 'toolbarjsx', level: 2 },
          { value: 'CanvasEditor.jsx', id: 'canvaseditorjsx', level: 2 },
          { value: 'DocumentEditor', id: 'documenteditor', level: 2 },
        ],
        d = { toc: l },
        u = 'wrapper';
      function p(e) {
        ...
        return (0, a.kt)(
          ...
          (0, a.kt)('h1', { id: 'quick-start' }, 'Quick Start'),
          (0, a.kt)(
            'p',
            null,
            "Let's discover ",
            (0, a.kt)(
              'strong',
              { parentName: 'p' },
              'Canvas Editor in less than 5 minutes'
            ),
            '.'
          ),
          ...
          (0, a.kt)(
            ...
            (0, a.kt)(
              'li',
              { parentName: 'ul' },
              (0, a.kt)('strong', { parentName: 'li' }, 'Initialization'),
              ":  To get started, you'll need to initialize the canvas document editor within your project. This involves specifying the container element where the editor will be embedded."
            )
          ),
          (0, a.kt)('h2', { id: 'toolbarjsx' }, 'toolbar.jsx'),
          (0, a.kt)(
            'pre',
            null,
            (0, a.kt)(
          ...
          (0, a.kt)('h2', { id: 'canvaseditorjsx' }, 'CanvasEditor.jsx'),
          (0, a.kt)(
            'pre',
            null,
            (0, a.kt)(
          ...
          (0, a.kt)('h2', { id: 'documenteditor' }, 'DocumentEditor'),
          (0, a.kt)(
            'pre',
            null,
            (0, a.kt)(
