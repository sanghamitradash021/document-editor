...
export class RangeManager {
  ...
  public getContentStyles() {
    ...
    if (this.pendingStyle && startIndex === endIndex) {
      ...
      if (this.pendingStyle.italic !== undefined)
        italic = !!this.pendingStyle.italic;
      if (this.pendingStyle.underline !== undefined)
        underline = !!this.pendingStyle.underline;
      if (this.pendingStyle.strikeout !== undefined)
        strikeout = !!this.pendingStyle.strikeout;
    }
